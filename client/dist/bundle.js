...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ManagerScreen\", function() { return ManagerScreen; });\n/* harmony import */ var _common_entity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/entity */ \"./src/js/common/entity.js\");\n/* harmony import */ var _ui_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ui/button */ \"./src/js/ui/button.js\");\n/* harmony import */ var _manager_panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manager_panel */ \"./src/js/ui/manager_panel.js\");\n/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/utils */ \"./src/js/common/utils.js\");\n\n\n\n\n\nclass ManagerScreen extends _common_entity__WEBPACK_IMPORTED_MODULE_0__[\"Entity\"] {\n    constructor(gr) {\n        super();\n        this.registry = gr;\n\n        this.closeCallback = null;\n    \n        this.closeBtn = new _ui_button__WEBPACK_IMPORTED_MODULE_1__[\"Button\"]({\n            label: 'X',\n            callback: () => { this.onClose(); },\n            width: 40,\n            height: 40,\n            fill: '#fcc',\n            stroke: '#a00',\n        });\n        this.closeBtn.setPos(650, 10);\n        this.children.push(this.closeBtn);\n\n        this.initManagerButtons();\n    }\n\n    onClose() {\n        this.visible = false;\n        if (this.closeCallback) {\n            console.log(`on close CB`);\n            this.closeCallback();\n        }\n    }\n\n    initManagerButtons() {\n        const { businessLookup } = this.registry;\n        let i=0;\n        businessLookup.forEach(bData => {\n            let mp = new _manager_panel__WEBPACK_IMPORTED_MODULE_2__[\"ManagerPanel\"](bData, this.registry);\n            mp.setPos(20, 130*i+80);\n            this.children.push(mp);\n            i++;\n        });\n\n    }\n\n    render(ctx) {\n        ctx.save();\n        ctx.fillStyle = '#b1b493';\n\n        Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__[\"drawRoundedRect\"])(ctx, 700, 500, 20);\n\n        ctx.fill();\n        ctx.stroke();\n        ctx.restore();\n\n        ctx.save();\n        ctx.fillStyle = '#000';\n        ctx.font = '50px helvetica';\n        ctx.translate(10, 60);\n        ctx.fillText('Buy Managers', 0, 0);\n\n        ctx.restore();\n    }\n\n}\n\n//# sourceURL=webpack:///./src/js/ui/manager_screen.js?");
